...
def send_mail_with_attach_ses(sender, recipient, aws_region, subject, account_name, table_data):
    ...
    <html>
        ...
        <body>
            ...
            <table>
                <tr><th style="border: 1px solid white; padding: 8px; text-align: left; background-color: #333333; color: white;">Instance ID</th>
                <th style="border: 1px solid white; padding: 8px; text-align: left; background-color: #333333; color: white;">Name</th>
                <th style="border: 1px solid white; padding: 8px; text-align: left; background-color: #333333; color: white;">Missing Tags</th></tr>
